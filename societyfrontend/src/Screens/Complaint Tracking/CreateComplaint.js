...
export default function CreateComplaint({ societyId, userInfo }) {
  ...
  async function createComplaint() {
    try {
      ...
      if (isEdit) {
        ...
        enqueueSnackbar('Complain Updated', { variant: 'info' })
      } else {
        await apiHelper.createComplaint({ ...data })
        enqueueSnackbar('Complain Create Succesfully!', { variant: 'success' })
  ...
  return <>
    <Paper elevation={5} className='p-2'>
      <div className="d-flex align-items-center justify-content-between mb-3 mt-1">
        <div className="h6 fw-bold mt-2">Create Complaint</div>
        <div>
          <button className='btn btn_primary fw-bold' onClick={() => setOpen(true)} ><AddBoxIcon />Create Complaint</button>
        </div>
      </div>
      <TableContainer>
        <Table sx={{ minWidth: 650, border: 0 }} aria-label="simple table">
          <TableHead style={{ background: "aliceblue" }}>
            <TableRow>
              <TableCell style={{ fontSize: "12px", fontWeight: "bold" }} align="left">Complainer Name</TableCell>
              <TableCell style={{ fontSize: "12px", fontWeight: "bold" }} align="left">Complaint Name</TableCell>
    ...
    <React.Fragment>
      <Dialog open={open} onClose={handleDailogClose}
        ...
        <DialogTitle className="" style={{ fontSize: "24px" }}>Create Complaint</DialogTitle>
        ...
        <DialogContent>
          ...
          <div className="mb-2" style={{ width: "100%" }}>
            <label style={{ fontSize: "14px", fontWeight: "500" }} htmlFor="description">Complainer Name<span style={{ color: "red" }}>*</span></label>
            <TextField
              disabled
              className="w-100"
              id="complainerName"
          ...
          <div className="my-2" style={{ width: "100%" }}>
            <label style={{ fontSize: "14px", fontWeight: "500" }} htmlFor="description">Complaint Name<span style={{ color: "red" }}>*</span></label>
            <TextField
              className="w-100"
              id="complaintName"
    ...
    <React.Fragment>
      <Dialog open={detailsOpen} onClose={handleClose}
        ...
        <DialogTitle className="" style={{ fontSize: "18px" }}>View Complaint</DialogTitle>
        <IconButton
          aria-label="close"
          onClick={handleClose}
          sx={(theme) => ({
